...
void bind_result(py::module_& module) {
    ...
    py::class_<neurodic::PINResult>(module, "PINResult")
        ...
        .def_readonly("training_history", &neurodic::PINResult::training_history)
        .def_readonly("evaluation_indices", &neurodic::PINResult::evaluation_indices)
        .def_readonly("evaluation_residuals", &neurodic::PINResult::evaluation_residuals)
        .def_readonly("evaluation_requested_count", &neurodic::PINResult::evaluation_requested_count)
        .def_readonly("evaluation_valid_count", &neurodic::PINResult::evaluation_valid_count)
        .def_readonly("evaluation_eligible_count", &neurodic::PINResult::evaluation_eligible_count)
        .def_readonly("evaluation_seed", &neurodic::PINResult::evaluation_seed)
        .def_readonly("evaluation_patch_radius", &neurodic::PINResult::evaluation_patch_radius)
        .def_readonly("evaluation_loss_type", &neurodic::PINResult::evaluation_loss_type)
    ...
    py::class_<neurodic::NDeFResult>(module, "NDeFResult")
        ...
        .def_readonly("evaluation_indices", &neurodic::NDeFResult::evaluation_indices)
        .def_readonly("evaluation_observation_surface_indices", &neurodic::NDeFResult::evaluation_observation_surface_indices)
        .def_readonly("evaluation_observation_camera_ids", &neurodic::NDeFResult::evaluation_observation_camera_ids)
        .def_readonly("evaluation_observation_residuals", &neurodic::NDeFResult::evaluation_observation_residuals)
        .def_readonly("evaluation_observation_reference_visible", &neurodic::NDeFResult::evaluation_observation_reference_visible)
        .def_readonly("evaluation_observation_positive_depth", &neurodic::NDeFResult::evaluation_observation_positive_depth)
        .def_readonly("evaluation_observation_in_bounds", &neurodic::NDeFResult::evaluation_observation_in_bounds)
        .def_readonly("evaluation_observation_patch_valid", &neurodic::NDeFResult::evaluation_observation_patch_valid)
        .def_readonly("evaluation_observation_valid", &neurodic::NDeFResult::evaluation_observation_valid)
        .def_readonly("evaluation_requested_count", &neurodic::NDeFResult::evaluation_requested_count)
        .def_readonly("evaluation_valid_count", &neurodic::NDeFResult::evaluation_valid_count)
        .def_readonly("evaluation_supervised_count", &neurodic::NDeFResult::evaluation_supervised_count)
        .def_readonly("evaluation_seed", &neurodic::NDeFResult::evaluation_seed)
        .def_readonly("evaluation_residual", &neurodic::NDeFResult::evaluation_residual)
