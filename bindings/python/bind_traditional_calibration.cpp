...
#include <neurodic/calibration/traditional/multiview_calibration.hpp>
#include <neurodic/calibration/traditional/stereo_calibration.hpp>
...
void bind_traditional_calibration(py::module_& m)
{
